...
Thanks for using Space Music! These Terms of Service ("Terms", "ToS") are a legal agreement between Space Music Bot ("we", "us") and you ("you" or "your"). By inviting, using, or distributing Space Music, any source code, any binary associated with Space Music or its parts, or our website, collectively referred to as "Space
...
At any time do we reserve the right to update these Terms with reasons including, but not limiting to adhering to new legal requirements, or improving your experience using Space Music. If the aforementioned changes affect your usage of Space Music or your legal rights, we will notify you no less than seven days before the changes take effect. Unless we state otherwise, your continued use of the Service after we post modifications will constitute your acceptance of and agreement to those changes. If you object to the changes, your recourse shall be to cease using the Service.
